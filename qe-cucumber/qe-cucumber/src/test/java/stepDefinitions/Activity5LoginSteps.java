...
public class Activity5LoginSteps extends Base{
    ...
    public void verifyMessage(String message1){
        String message = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//h2[@id='subheading']")))).getText();
        Assertions.assertEquals(message, "Invalid credentials");
